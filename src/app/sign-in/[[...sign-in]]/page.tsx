  ...
  return (
    <>
      <div className="flex justify-evenly items-center h-screen bg-gray-100 dark:bg-black w-full">
        ...
        <div
          className="w-screen max-w-md bg-white  rounded-lg shadow-lg p-6 flex flex-col md:flex-row justify-center items-center hover:bg-red-50 transition-colors duration-500 ease-in-out dark:bg-[rgb(225,222,222)] form-mode"
        >
          <SignIn />
        </div>
      </div>
